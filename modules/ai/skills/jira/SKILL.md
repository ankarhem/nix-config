...
**Run this check first** to determine if backend is available:
...
If CLI backend is not available, guide the user:

```
To use Jira, you need to install the jira cli:
